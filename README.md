...
## 🌐 การรันและแชร์ผ่านเครือข่ายท้องถิ่น (LAN) สำหรับทีม

ถ้าทีม Front-end อยู่บนเครื่องเดียวกันหรือเครือข่ายเดียวกัน (เช่น WiFi เดียวกัน หรือ VPN) คุณสามารถใช้ IP เครื่องแทน localhost ได้

### วิธีทำให้ทีมเข้าถึงได้จาก IP (วิธีที่คุณกำลังใช้อยู่)
...
2. หา IP ของเครื่องคุณ:
   - Windows: เปิด Command Prompt หรือ PowerShell พิมพ์ `ipconfig`
   - มองหา "IPv4 Address" ภายใต้ Wireless LAN adapter หรือ Ethernet (เช่น 10.0.20.96)

3. ทีม Front-end ใช้ URL แบบนี้แทน:
   - `http://10.0.20.96:3000/api/books` (แทน `http://localhost:3000`)

**สำคัญ:** 
- โค้ดในโปรเจกต์นี้ถูกปรับให้ `listen` บน `'0.0.0.0'` แล้ว (ดูใน server.js) ดังนั้นเครื่องอื่นในเครือข่ายสามารถเข้าถึงได้
- อย่าลืมอนุญาต Node.js ผ่าน Windows Defender Firewall ถ้าทีมเข้าไม่ได้

**ข้อจำกัดของวิธีนี้:**
- ใช้ได้เฉพาะเมื่อทุกคนอยู่ในเครือข่ายเดียวกัน
- เครื่องคุณต้องเปิดและรันเซิร์ฟเวอร์อยู่ตลอด
- ไม่เหมาะสำหรับการทดสอบจากภายนอกเครือข่าย

---

## 🌐 Deploy ขึ้นอินเทอร์เน็ต (ทางเลือกเมื่อต้องการแชร์กับคนภายนอก)
